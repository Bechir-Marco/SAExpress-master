    ...
    public static ByteArrayInputStream colisPDFReport (List <Colis> coliss, String barCodeColisDirectoryPath,
        ...
        try {
            ...
            for (Colis c3: coliss) {
                ...
                if(c3.getFournisseur()!=null) {
                	expContent.append("Nom Societé: "+c3.getFournisseur().getNom_societe()+"\n");
                	expContent.append("Adresse: "+c3.getFournisseur().getAdresse_societe()+"\n");
                	expContent.append("Governorat: "+c3.getFournisseur().getGouvernorat_societe()+"\n");
